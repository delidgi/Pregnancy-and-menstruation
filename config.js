...
export const defaultSettings = {
    ...
    // ── Тюнинг размера промпта ──
    promptCompact: false,       // компактный промпт: режем длинные пояснения (экономия токенов)
    promptCareNorms: true,      // нормы ухода за малышом + потребности по часам — в промпт
    promptChildUpdateTag: true, // разрешать модели дополнять профили детей (CHILD_UPDATE)
